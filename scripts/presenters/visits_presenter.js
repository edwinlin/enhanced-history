...
/* TODO: get this settings from a proper place so we do not
             need to reload to make it work*/
    if (window.router.cache.settings.attributes.use24HourClock) {
      return [
	      {label: 0, enabled: hours['0'], value: '0'},
	      ...
	      {label: 13, enabled: hours['13'], value: '13'},
	      {label: 14, enabled: hours['14'], value: '14'},
	      {label: 15, enabled: hours['15'], value: '15'},
	      {label: 16, enabled: hours['16'], value: '16'},
	      {label: 17, enabled: hours['17'], value: '17'},
	      {label: 18, enabled: hours['18'], value: '18'},
	      {label: 19, enabled: hours['19'], value: '19'},
	      {label: 20, enabled: hours['20'], value: '20'},
	      {label: 21, enabled: hours['21'], value: '21'},
	      {label: 22, enabled: hours['22'], value: '22'},
	      {label: 23, enabled: hours['23'], value: '23'}
      ].reverse();
    }else{
      return [
  ...
  VisitsPresenter.prototype.visitsByHour = function(visits) {
    var out = _.map(_.range(0, 24), function(hour) {
      ...
      date.setMinutes(0);
	      ...
	      return {
	        hour: hour,
	        hour_label: moment(date).format('HH:mm'),
	        visits: []
	      };
			else
	      return {
